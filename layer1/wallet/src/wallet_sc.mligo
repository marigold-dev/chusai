...
*)
let mint_xtz ({metadata; mint_address; bridge_address; ticket_storage} : wallet_storage) : wallet_return =
...
*)
let mint_xtz_cb (ticket_to_add, {metadata; mint_address; bridge_address; ticket_storage} : chusai_ticket*wallet_storage) : wallet_return = 
...
let redeem_xtz ({metadata; mint_address; bridge_address; ticket_storage} : wallet_storage) : wallet_return =
...
let send ({metadata; mint_address; bridge_address; ticket_storage} : wallet_storage) : wallet_return =
  let ticket = Option.unopt_with_error ticket_storage (error_message "No ticket found in storage") in
